...
argparser.add_argument("-b", "--batchsize", dest="batchsize", type=int, default=64, help="Batch size. (default=64)")
argparser.add_argument("-d", "--num_docs", dest="num_docs", type=int, default=10000, help="Total # docs in dataset. (default=10000)")
